...
- 본 README 및 안내문은 ChatGPT를 이용하여 초안을 생성하였습니다.
- 개발 이후 변경된 내용은 반영이 늦을 수 있으며, 프로젝트 관리자가 개발 실무 경험이 충분하지 않을 수 있으니 일부 내용이 현실과 다를 수 있음을 양해해 주시길 바랍니다.
- 상세 설치/운영/개발 안내는 별도 Wiki 문서로 추후 작성될 예정이며, 개발 기간 중의 Wiki는 개발에 적용된 주요 개념, 시행착오 및 우회적 조치의 사유 등을 기록하여 저자의 기억과 협업자의 이해를 돕는 자료로 활용할 계획입니다.