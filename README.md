...
- **협업자는**  
  - _개별 서비스/모듈의 작업 시 반드시 자신의 코드 및 설정을 본 저장소(monorepo)의 각 서비스 폴더에 추가하는 것을 검토해 주시길 바랍니다._
...
- 본 공지사항 및 프로젝트 운영지침은 ChatGPT의 프롬프트와 프로젝트 지침을 기반으로 자동 생성되었습니다.  
  안내 작성 이후 변경사항, 실제 개발 및 운영 상황에서의 차이, 일부 내용의 부정확성 등이 발생할 수 있으니 이 점 양해해 주시기 바랍니다.
